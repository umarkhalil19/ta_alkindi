            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <label for=""><?php echo $captcha['image']; ?></label>
                            <input style="background:white" class="form-control" type="text" autocomplete="off" name="userCaptcha" placeholder="Masukkan angka diatas .." value="<?php if (!empty($userCaptcha)) {
                                                                                                                                                                                        $userCaptcha;
                                                                                                                                                                                    } ?>" />
                        </div>
                    </div>
