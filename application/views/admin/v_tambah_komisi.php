<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <?php echo form_open('admin/tambah_komisi_act',['class'=>'form-horizontal']); ?>  
                <section class="panel">
                    <header class="panel-heading">
                        <h2 class="panel-title">Form Tambah Data Komisi</h2>
                    </header>
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Nama Komisi <span class="required">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" name="nama" class="form-control" placeholder="Nama Komisi" required/>
